...
##############################READING ALL DATASETS##############################
    ...
    for ds, dataset in enumerate(dbs):
        ...
        np.savetxt('./results/proposed/' + nome_serie + "_meanMSE.csv", average_error , delimiter="\t")
        del average_error
        ...
        name_save_result = './results/proposed/' + nome_serie + '_previsoes_PropostoArtigo.xlsx'
        ...
        arquivo_salvar = './results/proposed/' + nome_serie+"_PropostoArtigo.txt"
